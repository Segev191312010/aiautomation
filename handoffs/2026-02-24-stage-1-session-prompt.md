...
13. **Run `npm install && npm run build`** to verify everything compiles
14. **Write pytest tests** for settings CRUD, auth token, error format (if backend is accessible)
