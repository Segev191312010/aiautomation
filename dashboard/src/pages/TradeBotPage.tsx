...
interface PosSummary {
  symbol: string; entry_date: string | null; hold_time_days: number; qty: number;
  avg_cost: number; current_price: number; pnl: number; pnl_pct: number;
  rule_trigger: string; sl_price: number | null; tp_price: number | null;
