...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px]">
        <path d="M12 3c-.46 0-.93.04-1.4.14-2.76.53-4.96 2.76-5.48 5.52-.48 2.61.48 5.01 2.22 6.56.43.38.66.91.66 1.47V19c0 1.1.9 2 2 2h4c1.1 0 2-.9 2-2v-2.31c0-.55.22-1.09.64-1.46C18.09 13.95 19 12.08 19 10c0-3.87-3.13-7-7-7zm2 16h-4v-1h4v1zm0-2h-4v-1h4v1zm-1.5-4.74V14h-1v-1.74c-1.16-.41-2-1.51-2-2.76 0-1.65 1.35-3 3-3s3 1.35 3 3c0 1.25-.84 2.35-2 2.76z" />
      </svg>
    ),
  },
  {
