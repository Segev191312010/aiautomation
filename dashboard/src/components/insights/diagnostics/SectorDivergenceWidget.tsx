...
export default function SectorDivergenceWidget({ overview }: { overview: DiagnosticOverview | null }) {
  const data = overview?.widgets?.sector_divergence
  return (
    <div className="glass rounded-2xl shadow-glass p-3">
      <div className="text-xs font-sans font-medium text-terminal-dim tracking-wide">Sector Divergence</div>
