...
export default function SystemOverviewWidget({ overview }: { overview: DiagnosticOverview | null }) {
  const data = overview?.widgets?.system_overview
  return (
    <div className="glass rounded-2xl shadow-glass p-3">
      <div className="text-xs font-sans font-medium text-terminal-dim tracking-wide">System Overview</div>
