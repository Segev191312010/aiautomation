  ...
  return (
    <tr
      className={[
        ...
        isEven ? 'bg-transparent' : 'bg-zinc-900/60',
    ...
    >
      ...
      <td className="px-4 py-3 whitespace-nowrap">
        <div className="flex flex-col gap-0.5">
          <span className="font-mono text-[11px] text-zinc-400">{date}</span>
      ...
      <td className="px-4 py-3 max-w-[160px]">
        <span className="text-xs font-sans text-zinc-100 truncate block" title={h.alert_name}>
          {h.alert_name}
        </span>
      </td>
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-3">
        ...
        <div className="text-center">
          <p className="text-sm font-sans text-zinc-400 font-medium">No history yet</p>
          <p className="text-xs font-sans text-zinc-500 mt-1">Triggered alerts will appear here.</p>
        </div>
      </div>
    )
  }
            ...
            <tr className="border-b border-zinc-800 bg-zinc-900">
              {COLUMNS.map((col) => (
                <th
                  key={col}
                  className={[
                    'px-4 py-3 text-[11px] font-sans font-semibold text-zinc-500 tracking-wider uppercase',
