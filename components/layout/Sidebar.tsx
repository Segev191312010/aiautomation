...
export default function Sidebar() {
  const { sidebarCollapsed, toggleSidebar, activeRoute, setRoute } = useUIStore()
  const { quotes, watchlists, activeWatchlist, setSelectedSymbol } = useMarketStore()
  const { ibkrConnected, simMode, botRunning } = useBotStore()
