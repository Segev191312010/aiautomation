...
Legacy advisor endpoints that provide unique analytics not covered by the
autopilot API. Duplicated endpoints (guardrails, emergency-stop, audit-log,
ai-status, costs, learning-metrics, economic-report, shadow-*) have been
removed — use /api/autopilot/* instead.
"""
