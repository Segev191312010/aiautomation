...
TEMPLATES: dict[str, dict[str, Any]] = {
    "golden_cross": {
        ...
        "entry_conditions": [{"indicator": "SMA", "params": {"length": 50}, "operator": "crosses_above", "value": "SMA_200"}],
        "exit_conditions": [{"indicator": "SMA", "params": {"length": 50}, "operator": "crosses_below", "value": "SMA_200"}],
    ...
    "death_cross": {
        ...
        "category": "trend_following",
        "entry_conditions": [{"indicator": "SMA", "params": {"length": 50}, "operator": "crosses_below", "value": "SMA_200"}],
        "exit_conditions": [{"indicator": "SMA", "params": {"length": 50}, "operator": "crosses_above", "value": "SMA_200"}],
    ...
    "rsi_oversold_bounce": {
        ...
        "entry_conditions": [{"indicator": "RSI", "params": {"length": 14}, "operator": "<", "value": 30}],
        "exit_conditions": [{"indicator": "RSI", "params": {"length": 14}, "operator": ">", "value": 70}],
        "action": {"type": "BUY", "quantity": 10, "order_type": "MKT"}, "logic": "AND",
    ...
    "rsi_overbought_fade": {
        ...
        "category": "mean_reversion",
        "entry_conditions": [{"indicator": "RSI", "params": {"length": 14}, "operator": ">", "value": 70}],
        "exit_conditions": [{"indicator": "RSI", "params": {"length": 14}, "operator": "<", "value": 30}],
        "action": {"type": "SELL", "quantity": 10, "order_type": "MKT"}, "logic": "AND",
    ...
    "momentum_breakout": {
        ...
        "entry_conditions": [
            ...
            {"indicator": "RSI", "params": {"length": 14}, "operator": ">", "value": 60},
            {"indicator": "MACD", "params": {"fast": 12, "slow": 26, "signal": 9}, "operator": ">", "value": 0},
        ],
        "exit_conditions": [{"indicator": "RSI", "params": {"length": 14}, "operator": "<", "value": 40}],
        "action": {"type": "BUY", "quantity": 10, "order_type": "MKT"}, "logic": "AND",
    ...
    "triple_ma": {
        ...
        "exit_conditions": [{"indicator": "SMA", "params": {"length": 20}, "operator": "<", "value": "SMA_50"}],
        "action": {"type": "BUY", "quantity": 10, "order_type": "MKT"}, "logic": "AND",
    ...
    "stochastic_oversold": {
        ...
        "category": "mean_reversion",
        "entry_conditions": [{"indicator": "STOCH", "params": {"k": 14, "d": 3}, "operator": "<", "value": 20}],
        "exit_conditions": [{"indicator": "STOCH", "params": {"k": 14, "d": 3}, "operator": ">", "value": 80}],
        "action": {"type": "BUY", "quantity": 10, "order_type": "MKT"}, "logic": "AND",
